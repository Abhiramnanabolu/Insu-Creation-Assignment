    ...
    return(
        <div>
           ...
           <div className="flex flex-col items-center p-16 pb-24">
                ...
                <h1 className="text-3xl font-semibold mt-7">THE FEATURES TO CREATE YOUR</h1>
                <div className="w-3/4 flex gap-8 mt-12">
                    <div className="w-1/3 flex flex-col text-center p-8 shadow-card items-center">
                        <img src="https://res.cloudinary.com/dbs6hvga4/image/upload/v1716746851/Group_104_zwwdoq.png"/>
                        <p className="mt-4 font-semibold">Easy Copy And Paste</p>
                        <p className="mt-4 text-sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
                    <div className="w-1/3 flex flex-col text-center p-8 shadow-card items-center">
                        <img src="https://res.cloudinary.com/dbs6hvga4/image/upload/v1716746851/Group_104_zwwdoq.png"/>
                        <p className="mt-4 font-semibold">Easy Copy And Paste</p>
